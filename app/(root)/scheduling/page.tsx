...
export default async function SchedulingPage() {
    ...
    return (
        <div className="min-h-screen bg-[var(--surface-base)] py-20 px-4 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto space-y-16">
                <div className="text-center space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl mx-auto font-medium leading-relaxed">
